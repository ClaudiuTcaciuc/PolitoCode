...
console.log("Sorted by date watch:");
film_library.sortByDateWatch().forEach(film => console.log(film.toString()));
film_library.deleteFilm(2);
console.log("Reset watched films:");
film_library.resetWatchedFilms();
film_library.getRatedFilms();
film_library.printLibrary();