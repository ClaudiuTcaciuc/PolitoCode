...
if __name__ == '__main__':
    ...
    lambda_ = 1e-6
    x_opt, f_opt, info = opt.fmin_l_bfgs_b(logreg_obj, x0_iris_train, args=(data_train_centered, label_train, lambda_), approx_grad=True, maxls=200)
    ...
    accuracy = (score > 0).sum() * 1.0 / label_test.shape[0]
    err_rate = 1 - accuracy
